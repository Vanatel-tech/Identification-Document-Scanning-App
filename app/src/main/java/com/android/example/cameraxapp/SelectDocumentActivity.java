...
//                    Toast.makeText(SelectDocumentActivityKt.this, "Please select a document", Toast.LENGTH_SHORT).show();
//                } else if (radio_no_document.isChecked()) {
////                    If the No document radio is checked, start verify phone activity
//                    Intent noDocIntent = new Intent(SelectDocumentActivityKt.this, VerifyPhoneActivity.class);
...
//                    Intent intent = new Intent(SelectDocumentActivityKt.this, CameraActivity.class);
